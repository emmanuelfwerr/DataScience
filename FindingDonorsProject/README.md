# Finding Donors - a Supervised Learning ML project
...
1. `finding_donors.ipynb`: Jupyter NB containing analysis of dataset and project report
2. `census.csv`: The dataset in .csv format
